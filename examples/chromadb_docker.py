...
"""
To launch the ChromaDB server using Docker, run the following command in your terminal:
...
results = document_collection.query(query_texts="Who is the black widow?", n_results=3)
